...
<header id="header" class="header-scroll top-header headrom">
        ...
        <div class="page-wrapper">
         ...
         <p>Launched in Mumbai, Food Picky has grown from a home project to one of the largest food aggregators in the world. We are present in 24 countries and 10000+ cities globally, enabling our vision of better food for more people. We not only connect people to food in every context but work closely with restaurants to enable a sustainable ecosystem.</p>
        <br/>
        <h2>Register to BE AN AFFILIATE MARKETER</h1>
        <button onclick="location.href='marketerregister.php'" type="button" class="btn theme-btn btn-lg">Click on Register</button>
        <br/>
        <br/>
        <h2>Already a MARKETER ?</h1>
        <button onclick="location.href='signin.php'" type="button" class="btn theme-btn btn-lg">Login</button>
                        </center>
                        </div>
            </section>
