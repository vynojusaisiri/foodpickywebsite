                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        ...
                                        <p class="text-xs-center"> <a href="your_orders.php"><input type="submit" onclick="return confirm('Are you sure?');" name="submit"  class="btn btn-outline-success btn-block" value="Order now">click to view your orders</a> </p>
                                    </div>
									</form>
                                </div>
                            </div>
